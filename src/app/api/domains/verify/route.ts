...
export async function POST(request: Request) {
  ...
  const saveResult = await saveDomainRow(supabase, pageRow.id, parsed.data.domain, Boolean(vercelDomain.data.verified));
  ...
  return NextResponse.json({
    ...
    verified: Boolean(vercelDomain.data.verified),
    ...
    message: vercelDomain.data.verified
